...
const output = path.join(languageDirectory, 'LicencePress.pot');
...
function writeCatalog() {
  ...
  const header = [
    '# Translation catalog for LicencePress',
    '# Copyright (C) 2026 LicencePress contributors',
    '# This file is distributed under the same license as the plugin.',
    'msgid ""',
    'msgstr ""',
    '"Project-Id-Version: LicencePress 1.0.0\\n"',
    '"Content-Type: text/plain; charset=UTF-8\\n"',
    '"Content-Transfer-Encoding: 8bit\\n"',
    '"X-Domain: licencepress\\n"',
    '',
  ];
