...
final class LicencesManager extends Manager {
    ...
    public function register_assets( Assets $assets ): void {
        $this->register_page_assets( $assets, [ 'licencepress-licences', 'licencepress-licence-types', 'licencepress-licence-management', 'licencepress-licence-types-add' ], 'settings' );
    }
            ...
            <div class="card-body">
                ...
                <form id="licencepress-licence-type-form" data-nonce="<?php echo esc_attr( $nonce ); ?>" method="post">
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-md-4">
                            <?php echo FormFieldHelper::text_input( 'name', $settings['name'], [ 'id' => 'licence_type_name', 'class' => 'w-100', 'placeholder' => __( 'WordPress Plugin 1', 'licencepress' ) ] ); ?>
                        </div>
                        <div class="col-md-2">
                            <?php echo FormFieldHelper::text_input( 'prefix', $settings['prefix'], [ 'id' => 'licence_type_prefix', 'class' => 'w-100', 'placeholder' => 'WPP' ] ); ?>
                        </div>
                        <div class="col-md-2">
                            <?php echo FormFieldHelper::text_input( 'suffix', $settings['suffix'], [ 'id' => 'licence_type_suffix', 'class' => 'w-100', 'placeholder' => 'PRO' ] ); ?>
                        </div>
                        <div class="col-md-2">
                            <?php echo FormFieldHelper::text_input( 'length', (string) $settings['length'], [ 'id' => 'licence_type_length', 'type' => 'number', 'min' => 8, 'max' => 32, 'step' => 1, 'class' => 'w-100' ] ); ?>
                        </div>
                        <div class="col-md-2">
                            <?php echo FormFieldHelper::select( 'pattern', [
                            ...
                            ], $settings['pattern'], [ 'id' => 'licence_type_pattern', 'class' => 'w-100' ] ); ?>
                        </div>
                    </div>

                    <div class="row g-3 mt-1">
                        <div class="col-md-12">
                            <?php echo FormFieldHelper::textarea( 'description', '', [ 'id' => 'licence_type_description', 'rows' => 3, 'class' => 'w-100', 'placeholder' => __( 'Describe this licence type, its features, or the intended product bundle.', 'licencepress' ) ] ); ?>
                        </div>
                    </div>
                            ...
                            <?php else : ?>
                                <?php foreach ( $types as $type ) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo esc_html( ! empty( $type['parent_id'] ) ? sprintf( __( 'Parent #%s', 'licencepress' ), (int) $type['parent_id'] ) : __( 'Root type', 'licencepress' ) ); ?></td>
