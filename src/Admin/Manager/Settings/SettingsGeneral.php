...
final class SettingsGeneral {
	...
	public function render( array $values ): void {
		...
		$fields      = array(
			'licensor_name' => array(
				'label' => __( 'Name of Licensor', 'licencepress' ),
				'description' => __( 'The Licensor name is usualy the same as the product owner. e.g., your company name or personal name/developer username.', 'licencepress' ),
				'tooltip'  => __( 'The licensor name is also used as part of the encryption process for the licences generated by LicencePress.', 'licencepress' ),
			),
			'entity_type' => array(
				'label' => __( 'Is the default licensor a Company, Organization, Group or Individual entity?', 'licencepress' ),
				'description' => __( 'Select the default type of entity that will be acting as the licensor.', 'licencepress' ),
				'tooltip'  => __( 'The entity type of the default licensor is used for legal and administrative purposes.', 'licencepress' ),
				'type'  => 'radio_group',
				'items' => array(
