		...
		<header class="licencepress-header border-bottom">
			<nav class="navbar navbar-expand-lg" aria-label="<?php esc_attr_e( 'LicencePress header navigation', 'licencepress' ); ?>"> 
				<div class="container-fluid licencepress-shell px-3 px-lg-4">
					...
					<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#licencepress-header-menu" aria-controls="licencepress-header-menu" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle header navigation', 'licencepress' ); ?>">
