...
use LicencePress\Includes\Pages\Shortcodes as PageShortcodes;
...
/**
 * Coordinate LicencePress core registration and reusable WordPress services.
 *
 * Post types and taxonomies remain separate components; this class provides a
 * single lifecycle boundary for LicencePress and extension plugins.
 */
final class Core {
    /**
