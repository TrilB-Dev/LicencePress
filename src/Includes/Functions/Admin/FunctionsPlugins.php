...
final class FunctionsPlugins {
	...
	public function toggle_plugin(): void {
		...
		if ( ! $plugin instanceof PluginInterface ) {
			AjaxHelper::error( array( 'message' => __( 'The requested LicencePress plugin was not found.', 'licencepress' ) ), 404 );
		}
		...
		if ( ! Plugins::get_instance()->set_plugin_enabled( $slug, $enabled ) ) {
			AjaxHelper::error( array( 'message' => __( 'The LicencePress plugin state could not be saved.', 'licencepress' ) ), 500 );
		}
