...
final class FunctionsSettings {
    ...
    public function register_settings(): void {
        register_setting( 'licencepress_settings', 'licencepress_general', [ 'sanitize_callback' => [ $this, 'sanitize_general' ] ] );
        register_setting( 'licencepress_settings', 'licencepress_layout', [ 'sanitize_callback' => [ $this, 'sanitize_layout' ] ] );
        register_setting( 'licencepress_settings', 'licencepress_access', [ 'sanitize_callback' => [ $this, 'sanitize_access' ] ] );
        register_setting( 'licencepress_settings', 'licencepress_tools', [ 'sanitize_callback' => [ $this, 'sanitize_tools' ] ] );
