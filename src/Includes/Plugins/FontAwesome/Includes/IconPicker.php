		...
		if ( function_exists( 'add_action' ) ) {
			$this->loader->register_component(
				...
				array(
					array(
						'type'     => 'action',
						'hook'     => 'wp_ajax_licencepress_fontawesome_search_icons',
						'callback' => 'ajax_search_icons',
					),
					array(
						'type'     => 'action',
						'hook'     => 'wp_ajax_licencepress_fontawesome_get_icon_data',
				...
				echo wp_kses_post(
					FormFieldHelper::input(
						...
						array(
							'type'  => 'hidden',
							'id'    => $args['input_id'],
							'class' => 'licencepress-fa-picker-input',
						)
					)
				);
				?>
			...
			<div class="licencepress-fa-picker-modal" style="display: none;">
				...
				<div class="licencepress-fa-picker-dialog">
					...
					<div class="licencepress-fa-picker-search">
						...
						echo wp_kses_post(
							FormFieldHelper::input(
								'licencepress_fa_search',
								'',
								array(
									'type'        => 'search',
									'class'       => 'licencepress-fa-picker-search-input',
									'placeholder' => __( 'Search icons...', 'licencepress' ),
								)
							)
						);
						?>
						...
						echo wp_kses_post(
							FormFieldHelper::select(
								'licencepress_fa_pack',
								array(
									'classic'       => __( 'Classic', 'licencepress' ),
									'duotone'       => __( 'Duotone', 'licencepress' ),
									'sharp'         => __( 'Sharp', 'licencepress' ),
									'sharp-duotone' => __( 'Sharp Duotone', 'licencepress' ),
									'brands'        => __( 'Brands', 'licencepress' ),
								),
								'classic',
								array( 'class' => 'licencepress-fa-picker-pack-filter' )
							)
						);
						?>
						<?php
						echo wp_kses_post(
							FormFieldHelper::select(
								'licencepress_fa_style',
								array(
									'solid'   => __( 'Solid', 'licencepress' ),
									'regular' => __( 'Regular', 'licencepress' ),
									'light'   => __( 'Light', 'licencepress' ),
									'thin'    => __( 'Thin', 'licencepress' ),
								),
								'solid',
								array( 'class' => 'licencepress-fa-picker-style-filter' )
							)
						);
						?>
					</div>
