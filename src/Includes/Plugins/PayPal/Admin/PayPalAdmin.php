...
final class PayPalAdmin {
    public static function get_admin_menu(): array {
        return [
            [
                ...
                'position' => 32,
                'callback' => [ self::class, 'render_dashboard' ],
                'children' => [
                    [
                    ...
                    [
                        ...
                        'callback' => [ self::class, 'render_subscriptions' ],
                    ],
                    [
                        ...
                        'callback' => [ self::class, 'render_settings' ],
                    ],
                ],
            ],
        ];
    ...
    public static function get_admin_sidebar(): array {
        $settings = LicencePressSettings::get_group( 'paypal', [] );
    ...
    public static function render_dashboard(): void {
        ...
        <div class="wrap licencepress-paypal-wrap">
            ...
            <div class="card" style="max-width: 920px; padding: 20px; margin-top: 20px;">
                ...
                <p><strong><?php echo esc_html__( 'Client ID:', 'licencepress' ); ?></strong> <?php echo esc_html( $client_id ?: __( 'Not configured', 'licencepress' ) ); ?></p>
    ...
    public static function maybe_handle_oauth_connect(): void {
        ...
        wp_redirect( PayPalOAuthHelper::build_connect_url( $settings, $state ) );
        exit;
    }
