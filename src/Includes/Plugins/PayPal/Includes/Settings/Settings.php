...
final class Settings {
        ...
        return [
            ...
            'fields' => [
                ...
                [
                    ...
                    'type' => 'custom',
                    'render' => [ self::class, 'render_oauth_connection' ],
                ],
            ],
        ];
    }
    ...
    public static function render_oauth_connection( $value, string $name, string $id ): void {
        $settings = BaseSettings::get_group( self::GROUP, [] );
    ...
    public function sanitize( $input ): array {
        ...
        $settings = [
            'paypal_environment' => in_array( sanitize_key( (string) ( $input['paypal_environment'] ?? '' ) ), self::ENVIRONMENTS, true )
                ? sanitize_key( (string) $input['paypal_environment'] )
            ...
            'paypal_currency' => strtoupper( sanitize_text_field( (string) ( $input['paypal_currency'] ?? 'USD' ) ) ) ?: 'USD',
