<?php
/**
 * LicencePress Plugin interface for all plugins.
 *
...
/**
 * Provides an automatically generated settings tab for a LicencePress plugin.
 * @since 1.0.0
 */
...
/**
 * Provides shortcode definitions for a LicencePress extension.
 * @since 1.0.0
 */
...
/**
 * Provides LicencePress admin menu definitions for a plugin.
 *
 * Definitions may use `type => menu` for a new top-level menu or provide a
 * `parent` slug for a submenu under an existing LicencePress menu.
 * @since 1.0.0
 */
...
/**
 * Provides entries for the LicencePress in-page admin sidebar.
 * @since 1.0.0
 */
