	...
	public static function get_admin_menu(): array {
		return array(
			array(
				...
				'menu_slug'  => 'licencepress&group=stripe&tab=dashboard',
				...
				'children'   => array(
					...
					array(
						...
						'menu_slug'  => 'licencepress&group=stripe&tab=checkout',
					...
					array(
						...
						'menu_slug'  => 'licencepress&group=stripe&tab=subscriptions',
					...
					array(
						...
						'menu_slug'  => 'licencepress&group=stripe&tab=settings',
	...
	public static function get_admin_sidebar(): array {
		...
		return array(
			array(
				...
				'items'      => array(
					array(
						'label'      => __( 'Dashboard', 'licencepress' ),
						'page'       => 'licencepress&group=stripe&tab=dashboard',
						'capability' => 'licencepress_stripe_view',
						'icon'       => 'fa-solid fa-gauge-high',
					),
					array(
						'label'      => __( 'Checkout', 'licencepress' ),
						'page'       => 'licencepress&group=stripe&tab=checkout',
						'capability' => 'licencepress_stripe_checkout',
						'icon'       => 'fa-solid fa-cart-shopping',
					),
					array(
						'label'      => __( 'Subscriptions', 'licencepress' ),
						'page'       => 'licencepress&group=stripe&tab=subscriptions',
						'capability' => 'licencepress_stripe_subscriptions',
						'icon'       => 'fa-solid fa-repeat',
					),
					array(
						'label'      => __( 'Settings', 'licencepress' ),
						'page'       => 'licencepress&group=stripe&tab=settings',
						'capability' => 'licencepress_stripe_manage',
