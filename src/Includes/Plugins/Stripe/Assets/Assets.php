<?php
/**
 * Stripe Editor Plugin Assets
 *
 * @package LicencePress
 * @subpackage Plugins\Stripe\Assets
 * @since 1.0.0
 */

namespace LicencePress\Includes\Plugins\Stripe\Assets;

use LicencePress\Includes\Plugins\Stripe\Includes\Settings\Settings;
...
final class Assets {
	...
	/**
	 * Constructor for the Stripe plugin assets.
	 *
	...
	/**
	 * Registers the Stripe plugin assets with the core assets manager.
	 *
	 * @return void
	 */
	...
	/**
	 * Registers the admin assets for the Stripe plugin.
	 *
	 * @param array  $assets The current assets.
	 * @param string $context The context (e.g., 'frontend', 'admin').
	 * @return array The updated assets with Stripe assets included.
	 */
	...
	public static function get_image( string $file ): string {
		return ImageHelper::get_image_url( 'licencepress-stripe', $file );
	}
}
