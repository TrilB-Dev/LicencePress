...
final class Frontend {
    ...
    private function render_breadcrumbs(): string {
        $items = [ '<a href="' . esc_url( get_post_type_archive_link( PostType::PAGE ) ?: home_url( '/' ) ) . '">' . esc_html( Settings::get_string( 'root_name', __( 'LicencePress', 'licencepress' ) ) ) . '</a>' ];
